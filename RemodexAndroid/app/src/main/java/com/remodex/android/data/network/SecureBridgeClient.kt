...
import com.remodex.android.data.model.HandshakeMode
...
class SecureBridgeClient(
    ...
    private suspend fun performHandshake(
        ...
        val infoPrefix = "${com.remodex.android.data.model.SECURE_HANDSHAKE_TAG}|${pairingRecord.bridgeId}|${pairingRecord.macDeviceId}|${phoneIdentityState.phoneDeviceId}|$keyEpoch"
    ...
    private suspend fun sendRpcMessage(message: JsonObject) {
        ...
        if (!sent) {
            throw IllegalStateException("Unable to send message to Remodex bridge.")
        }
    }
