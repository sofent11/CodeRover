...
function createRuntimeStore({ baseDir = DEFAULT_STORE_DIR } = {}) {
    ...
    function saveThreadHistory(threadId, history) {
        ...
        fs.mkdirSync(threadsDir, { recursive: true });
        fs.writeFileSync(threadHistoryPath(normalizedThreadId), JSON.stringify(normalizedHistory, null, 2));
        return normalizedHistory;
    }
    function createThread({ id, provider, providerSessionId = null, title = null, name = null, preview = null, cwd = null, model = null, metadata = null, capabilities = null, createdAt = null, updatedAt = null, archived = false, }) {
