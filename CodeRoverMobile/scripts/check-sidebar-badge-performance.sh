...
PROJECT_PATH="$ROOT_DIR/CodeRoverMobile.xcodeproj"
...
xcodebuild \
  ...
  test \
  -only-testing:CodeRoverMobileTests/SidebarRunBadgePerformanceTests/testSidebarRunBadgeSnapshotPerformance \
  -only-testing:CodeRoverMobileTests/SidebarRunBadgePerformanceTests/testSidebarRunBadgeSnapshotWithLargeTimelinePerformance \
  2>&1 | tee "$run_log"
