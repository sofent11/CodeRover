...
xcodebuild \
  ...
  test \
  -only-testing:CodeRoverMobileUITests/CodeRoverMobileUITests/testTurnTimelineScrollingPerformance \
  -only-testing:CodeRoverMobileUITests/CodeRoverMobileUITests/testTurnStreamingAppendPerformance \
  2>&1 | tee "$run_log"
