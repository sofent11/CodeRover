...
final class CodeCommentDirectiveParserTests: XCTestCase {
    func testParseExtractsSingleFindingAndCleansFallbackText() {
        ...
        ::code-comment{title="[P1] Active thread can stay stuck" body="The sync state returns early and hides the final output." file="CodeRoverService+Sync.swift" start=432 end=441 priority=1 confidence=0.92}
        """
