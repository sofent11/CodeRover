...
// Depends on: XCTest, CodeRoverService, ConversationThread
...
private extension SidebarRunBadgePerformanceTests {
    func makeRunBadgeSnapshotCount(service: CodeRoverService) -> Int {
        var snapshot: [String: ConversationThreadRunBadgeState] = [:]
    ...
    func makeService(threadCount: Int) -> CodeRoverService {
