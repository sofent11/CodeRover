...
final class UserMessageParserTests: XCTestCase {
    func testParseKeepsLeadingFileMentionWithSpaces() {
        let parsed = UserMessageParser.parse(
            "@CodeRover Mobile App Plan/CodeRover iOS Recap TLDR.md add other 2 lines"
        )

        XCTAssertEqual(parsed.mentions, ["CodeRover Mobile App Plan/CodeRover iOS Recap TLDR.md"])
