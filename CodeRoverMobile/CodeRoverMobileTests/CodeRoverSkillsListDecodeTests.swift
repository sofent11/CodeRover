// FILE: CodeRoverSkillsListDecodeTests.swift
// Purpose: Verifies skills/list response decoding across supported payload shapes.
// Layer: Unit Test
// Exports: CodeRoverSkillsListDecodeTests
...
@MainActor
final class CodeRoverSkillsListDecodeTests: XCTestCase {
        ...
        let result: JSONValue = .object([
            "skills": .array([
                .object([
                    ...
                    "path": .string("/Users/me/.coderover/skills/check-code/SKILL.md"),
                    "scope": .string("global"),
                    "enabled": .bool(true),
                ]),
            ]),
    ...
    private func makeService() -> CodeRoverService {
        let suiteName = "CodeRoverSkillsListDecodeTests.\(UUID().uuidString)"
