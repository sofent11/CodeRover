// FILE: CodeRoverService+AIChangeSets.swift
// Purpose: Tracks assistant-scoped patch ledgers and executes safe reverse-patch previews/applies.
// Layer: Service
// Exports: CodeRoverService AI change-set APIs
// Depends on: AIChangeSetModels, CodeRoverService transport, GitActionModels
...
extension CodeRoverService {
    ...
    func aiChangeSet(forAssistantMessage message: ChatMessage) -> AIChangeSet? {
    ...
    func readyChangeSet(forAssistantMessage message: ChatMessage) -> AIChangeSet? {
...
private extension CodeRoverService {
    ...
    func bridgeError(from error: CodeRoverServiceError) -> AIChangeSetError {
        switch error {
        case .disconnected:
