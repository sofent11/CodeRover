...
// Depends on: ChatMessage, TurnFileChangeSummaryParser
...
enum TurnSessionDiffResetMarker {
    ...
    static func isResetMessage(_ message: ChatMessage) -> Bool {
...
enum TurnSessionDiffSummaryCalculator {
    ...
    private static func messagesAfterMostRecentPush(in messages: [ChatMessage]) -> ArraySlice<ChatMessage> {
