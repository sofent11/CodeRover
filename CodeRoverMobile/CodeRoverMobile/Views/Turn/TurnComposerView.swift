...
// Depends on: SwiftUI, ComposerAttachmentsPreview, ComposerBottomBar, QueuedDraftsPanel, TurnComposerInputTextView
    ...
    var body: some View {
        VStack(spacing: 6) {
            ...
            VStack(spacing: 0) {
                ...
                .padding(.horizontal, 16)
                .padding(.top, composerAttachments.isEmpty ? 14 : 8)
                .padding(.bottom, 12)
