...
// Depends on: CodeRoverService, ConversationThread
...
struct ArchivedChatsView: View {
    ...
    private var archivedThreads: [ConversationThread] {
        coderover.threads
    ...
    private func archivedRow(_ thread: ConversationThread) -> some View {
        HStack {
