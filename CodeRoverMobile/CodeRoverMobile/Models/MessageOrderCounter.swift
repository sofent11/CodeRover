// FILE: MessageOrderCounter.swift
// Purpose: Thread-safe monotonically increasing counter for message ordering.
// Layer: Model
// Exports: MessageOrderCounter
// Depends on: Foundation

import Foundation
import os

/// Provides a globally unique, monotonically increasing order index for ChatMessage.
...
enum MessageOrderCounter {
    ...
    static func seed(from allMessages: [String: [ChatMessage]]) {
